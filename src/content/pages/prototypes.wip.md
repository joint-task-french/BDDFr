...
Le mode Escalade porte bien son nom : à chaque Tier franchi, la difficulté grimpe d'un cran. Les ennemis frappent plus fort, encaissent plus de dégâts et leur armure se renforce.
...
|:-------------|:--------------|:-------------|:-------|:---------------------|---------------|---------------|
| **Tier 1**   | 60 %          | 0 %          | 0 %    | 0 %                  |               |               |
| **Tier 2**   | 60 %          | 0 %          | 0 %    | 0 %                  | Actif         |               |
| **Tier 3**   | 75 %          | 35 %         | 0 %    | 0 %                  |               |               |
| **Tier 4**   | 75 %          | 35 %         | 0 %    | 0 %                  |               |               |
| **Tier 5**   | 75 %          | 35 %         | 35 %   | 0 %                  |               |               |
| **Tier 6**   | 75 %          | 35 %         | 60 %   | 0 %                  |               | Actif         |
| **Tier 7**   | 75 %          | 35 %         | 60 %   | 35 %                 |               | Actif         |
| **Tier 8**   | 75 %          | 35 %         | 75 %   | 60 %                 |               | Actif         |
| **Tier 9**   | 75 %          | 60 %         | 75 %   | 60 %                 |               | Actif         |
| **Tier 10**  | 75 %          | 60 %         | 75 %   | 75 %                 |               | Actif         |

#### Modificateurs ennemis :

**Moissonneur :** Lorsqu'il subit des dégâts, cet ennemi régénère sa protection et sa santé à hauteur d'un pourcentage de votre protection maximale. Peut entraîner un excédent de soins.
**Suppresseur :** Lorsqu'il subit des dégâts, cet ennemi commence à charger une IEM. Une fois la charge terminée, l'IEM se déclenche, désactivant tout ce qui se trouve dans la zone.
**Ancre :** Cet ennemi bénéficie d'une résistance aux dégâts et tire des munitions incendiaires tant qu'il a des alliés autour de lui.
**Spécialiste soutien :** Cet ennemi répare régulièrement la protection de tous les alliés qui l'entourent, s'ils sont gravement endommagés.

#### Modificateurs globaux : 

**Imperturbable :** Tous les ennemis deviennent immunisés aux effets de contrôle de foule lorsqu'ils subissent des dégâts importants.
**Jambes en feu :** Si vous restez trop longtemps au même endroit, un compteur de charge commence à se remplir. Lorsqu'il atteint son maximum, vous bous faites électrocuter et subissez des dégâts.
